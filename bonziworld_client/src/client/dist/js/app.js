...
window.onload = function () {
	...
	$.contextMenu({
        ...
        uwu: { name: "UwU~", disabled: function() { return adult != true; }, callback: function () { theme(''); var uwu_yes_daddy_fuck_me = new Audio("./sfx/the-hub.mp3"); uwu_yes_daddy_fuck_me.play() } }
			}
	}),
	$("#dm_input").keypress(n => {
